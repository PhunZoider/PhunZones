...
| Announce    | bool\*   | false   | Show the title of this location to the player when entering                                                                                                                                                                                                                         | `Announce=true`                                                     |
...
| building    | bool\*   | true    | Allow building as usual. Set to `false` to explicitly prevent building stuff in this zone                                                                                                                                                                                           | `building=false`                                                    |
| placing     | bool\*   | true    | Allow objects to be placed as usual (eg TV). Set to `false` to explicitly prevent stuff from being placed                                                                                                                                                                           | `placing=false`                                                     |
| pickup      | bool\*   | true    | Allow objects to be picked up (eg TV). Set to `false` to explicitly prevent this                                                                                                                                                                                                    | `pickup=false`                                                      |
| scrap       | bool\*   | true    | Allow objects to be dissassembled and scrapped as normal. Set to `false` to explicitly prevent this                                                                                                                                                                                 | `scrap=false`                                                       |
| destruction | bool\*   | true    | Allow sledgehammer to be used as normal. Set to `false` to explicitly prevent this                                                                                                                                                                                                  | `destruction=false`                                                 |
| fire        | bool\*   | true    | Allow fire to spread as normal. Set to `false` to explicitly prevent this                                                                                                                                                                                                           | `fire=false`                                                        |
